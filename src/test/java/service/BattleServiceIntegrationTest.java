...
public class BattleServiceIntegrationTest {
    ...
    void createBattle_shouldReturnABattle(){
       /* TrainerService trainerService = Mockito.mock(TrainerService.class);
        ...
        battleService.setTrainerService(trainerService);
        BattlePokemonFactory battlePokemonFactory = Mockito.mock(BattlePokemonFactory.class);
        battleService.setBattlePokemonFactory(battlePokemonFactory);
